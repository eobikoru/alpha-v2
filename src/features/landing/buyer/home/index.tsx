...
const BuyerHome = () => {
    ...
    const showDetailsModal = (appointment :any) => {
  ...
  return (
    ...
    <div className="relative h-48 w-full bg-gradient-to-r from-purple-600 to-pink-600">
      <Image
       src="/assets/images/banner.png" alt="Cryptocurrency Banner"
        fill
                  ...
                  children: (
                    <Card className="bg-zinc-900/50 border-zinc-800 mt-6">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        type="link" className="text-emerald-500 hover:text-emerald-400">
                          View All
                        </Button>
                      </div>
      ...
      >
        {selectedAppointment && (
          <div className="flex flex-col  gap-6">
            <div className="flex items-start gap-4">
              <Avatar size={64} src={selectedAppointment?.avatar} className="bg-blue-600" />
              <div>
